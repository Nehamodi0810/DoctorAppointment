...
<body >
	...
	<div class="container">
		...
		<ul>
			<a href="PatientHome.jsp"> Book An Appointment</li></a>
			<a href="PatientProfileUpdate.jsp"> Update Profile</li></a>
			
			<a href="Feedback.jsp">Feedback</li></a>
			<a href="DoctorList.jsp">DoctorList</li></a>
			<a href="Logout">Logout</li></a>
		...
		<tr><td>Contact No:</td><td><input type="tel" name="contact" pattern="^\d{10}$" placeholder="xxxxxxxxxx"  required></td></tr>
		
		<tr><td>Age:</td><td><input type="number" name="age" min="1" max="100" required></td> </tr>
		
		<tr><td>Date</td><td><input type="date" name="day" max="2021-01-31" min="2020-12-20" required></td></tr>
